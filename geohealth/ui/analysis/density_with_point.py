...
# Form implementation generated from reading ui file 'density_with_point.ui'
#
# Created: Sun Apr 24 11:36:55 2016
...
class Ui_DensityPoint(object):
    def setupUi(self, DensityPoint):
        DensityPoint.setObjectName(_fromUtf8("DensityPoint"))
        DensityPoint.resize(663, 613)
        self.verticalLayout = QtGui.QVBoxLayout(DensityPoint)
        self.verticalLayout.setObjectName(_fromUtf8("verticalLayout"))
        self.formLayout = QtGui.QFormLayout()
        self.formLayout.setFieldGrowthPolicy(QtGui.QFormLayout.ExpandingFieldsGrow)
        self.formLayout.setObjectName(_fromUtf8("formLayout"))
        self.label_4 = QtGui.QLabel(DensityPoint)
        self.label_4.setObjectName(_fromUtf8("label_4"))
        self.formLayout.setWidget(0, QtGui.QFormLayout.LabelRole, self.label_4)
        self.label = QtGui.QLabel(DensityPoint)
        self.label.setObjectName(_fromUtf8("label"))
        self.formLayout.setWidget(2, QtGui.QFormLayout.LabelRole, self.label)
        self.label_2 = QtGui.QLabel(DensityPoint)
        self.label_2.setObjectName(_fromUtf8("label_2"))
        self.formLayout.setWidget(3, QtGui.QFormLayout.LabelRole, self.label_2)
        self.cbx_ratio = QtGui.QComboBox(DensityPoint)
        ...
        self.label_3 = QtGui.QLabel(DensityPoint)
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.formLayout.setWidget(4, QtGui.QFormLayout.LabelRole, self.label_3)
        self.le_new_column = QtGui.QLineEdit(DensityPoint)
        ...
        self.checkBox_addNbIntersections = QtGui.QCheckBox(DensityPoint)
        ...
        self.checkBox_incidence_runStats = QtGui.QCheckBox(DensityPoint)
        ...
        self.button_browse = QtGui.QPushButton(DensityPoint)
        ...
        self.cbx_case_layer = QgsMapLayerComboBox(DensityPoint)
        ...
        self.cbx_aggregation_layer = QgsMapLayerComboBox(DensityPoint)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.symbology = QgsCollapsibleGroupBox(DensityPoint)
        ...
        self.button_box_ok = QtGui.QDialogButtonBox(DensityPoint)
        ...
        self.tableWidget = QtGui.QTableWidget(DensityPoint)
        ...
        self.retranslateUi(DensityPoint)
        self.cbx_ratio.setCurrentIndex(4)
        QtCore.QMetaObject.connectSlotsByName(DensityPoint)

    def retranslateUi(self, DensityPoint):
        DensityPoint.setWindowTitle(_translate("DensityPoint", "Density", None))
        self.label_4.setText(_translate("DensityPoint", "Case layer", None))
        self.label.setText(_translate("DensityPoint", "Layer for aggregation", None))
        self.label_2.setText(_translate("DensityPoint", "Ratio", None))
        self.cbx_ratio.setItemText(0, _translate("DensityPoint", "10", None))
        self.cbx_ratio.setItemText(1, _translate("DensityPoint", "100", None))
        self.cbx_ratio.setItemText(2, _translate("DensityPoint", "1 000", None))
        self.cbx_ratio.setItemText(3, _translate("DensityPoint", "10 000", None))
        self.cbx_ratio.setItemText(4, _translate("DensityPoint", "100 000", None))
        self.label_3.setText(_translate("DensityPoint", "New column", None))
        self.le_new_column.setPlaceholderText(_translate("DensityPoint", "density", None))
        self.checkBox_addNbIntersections.setToolTip(_translate("DensityPoint", "Add the number of cases per unit to the attribute table", None))
        self.checkBox_addNbIntersections.setText(_translate("DensityPoint", "Add the number of cases per unit to the attribute table", None))
        self.checkBox_incidence_runStats.setText(_translate("DensityPoint", "Calculate statistics", None))
        self.label_5.setText(_translate("DensityPoint", "Output", None))
        self.le_output_filepath.setPlaceholderText(_translate("DensityPoint", "Save to temporary file", None))
        self.button_browse.setText(_translate("DensityPoint", "Browse", None))
        self.symbology.setTitle(_translate("DensityPoint", "Add a symbology", None))
        self.label_9.setText(_translate("DensityPoint", "Low incidence", None))
        self.label_10.setText(_translate("DensityPoint", "High incidence", None))
        self.label_11.setText(_translate("DensityPoint", "Classes", None))
        self.label_12.setText(_translate("DensityPoint", "Mode", None))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("DensityPoint", "Parameter", None))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("DensityPoint", "Value", None))
