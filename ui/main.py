...
#
# Created: Fri Oct 30 14:22:16 2015
...
"}"))
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/GeoHealth/resources/shp.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item_1.setIcon(0, icon1)
        item_1 = QtGui.QTreeWidgetItem(item_0)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/GeoHealth/resources/raster.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item_1.setIcon(0, icon2)
        item_1 = QtGui.QTreeWidgetItem(item_0)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/GeoHealth/resources/csv.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item_1.setIcon(0, icon3)
        item_1 = QtGui.QTreeWidgetItem(item_0)
        item_1.setIcon(0, icon3)
        item_1 = QtGui.QTreeWidgetItem(item_0)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/GeoHealth/resources/xy.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item_1.setIcon(0, icon4)
        item_0 = QtGui.QTreeWidgetItem(self.menu)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/GeoHealth/resources/gears.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item_0.setIcon(0, icon5)
        item_1 = QtGui.QTreeWidgetItem(item_0)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/GeoHealth/resources/blur.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item_1.setIcon(0, icon6)
        item_1 = QtGui.QTreeWidgetItem(item_0)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/GeoHealth/resources/incidence.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/GeoHealth/resources/histogram.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        item_1.setFont(0, font)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/GeoHealth/resources/sigma.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item_1.setIcon(0, icon9)
        item_0 = QtGui.QTreeWidgetItem(self.menu)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/GeoHealth/resources/export.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        item_1.setFont(0, font)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/GeoHealth/resources/kml.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.menu.topLevelItem(0).child(0).setText(0, _translate("Dialog", "Shapefile", None))
        self.menu.topLevelItem(0).child(1).setText(0, _translate("Dialog", "Raster", None))
        self.menu.topLevelItem(0).child(2).setText(0, _translate("Dialog", " Table XLS, DBF", None))
        self.menu.topLevelItem(0).child(3).setText(0, _translate("Dialog", "Table CSV", None))
        self.menu.topLevelItem(0).child(4).setText(0, _translate("Dialog", "XY to map", None))
