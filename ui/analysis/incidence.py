...
#
# Created: Sun Apr 10 17:34:07 2016
...
class Ui_Incidence(object):
    def setupUi(self, Incidence):
        ...
        self.cbx_ratio.addItem(_fromUtf8(""))
        self.cbx_ratio.addItem(_fromUtf8(""))
        self.formLayout.setWidget(6, QtGui.QFormLayout.FieldRole, self.cbx_ratio)
        ...
        self.formLayout.setWidget(7, QtGui.QFormLayout.FieldRole, self.le_new_column)
        ...
        self.formLayout.setWidget(8, QtGui.QFormLayout.FieldRole, self.checkBox_addNbIntersections)
        ...
        self.formLayout.setWidget(9, QtGui.QFormLayout.FieldRole, self.checkBox_incidence_runStats)
        ...
        self.cbx_aggregation_layer = QgsMapLayerComboBox(Incidence)
        ...
        self.cbx_case_field = QgsFieldComboBox(Incidence)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.cbx_population_field = QgsFieldComboBox(Incidence)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.formLayout.setWidget(5, QtGui.QFormLayout.FieldRole, self.cbx_population_field)
        self.verticalLayout.addLayout(self.formLayout)
        self.symbology = QgsCollapsibleGroupBox(Incidence)
        ...
        QtCore.QObject.connect(self.cbx_aggregation_layer, QtCore.SIGNAL(_fromUtf8("layerChanged(QgsMapLayer*)")), self.cbx_population_field.setLayer)
    ...
    def retranslateUi(self, Incidence):
        ...
        self.label.setText(_translate("Incidence", "Layer", None))
        self.label_7.setText(_translate("Incidence", "Population field", None))
        ...
        self.label_4.setText(_translate("Incidence", "Case field", None))
