...
#
# Created: Fri Jan  1 18:17:30 2016
...
class Ui_DensityPoint(object):
    def setupUi(self, DensityPoint):
        ...
        self.cbx_case_layer = QtGui.QComboBox(DensityPoint)
        ...
        self.cbx_aggregation_layer = QtGui.QComboBox(DensityPoint)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.symbology = gui.QgsCollapsibleGroupBox(DensityPoint)
